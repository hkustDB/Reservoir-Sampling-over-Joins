...
QyAttributeHouseholdDemographicsHouseholdDemographics::~QyAttributeHouseholdDemographicsHouseholdDemographics() {
...
void QyAttributeHouseholdDemographicsHouseholdDemographics::set_left_attribute(QyAttributeCustomerHouseholdDemographics *attribute) {
    this->left_attribute = attribute;
}

void QyAttributeHouseholdDemographicsHouseholdDemographics::set_right_attribute(QyAttributeHouseholdDemographicsCustomer *attribute) {
    this->right_attribute = attribute;
}

void QyAttributeHouseholdDemographicsHouseholdDemographics::set_left_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QyAttributeHouseholdDemographicsHouseholdDemographics::set_right_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QyAttributeHouseholdDemographicsHouseholdDemographics::update_from_left(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeHouseholdDemographicsHouseholdDemographics::update_from_right(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
    int key = row->hd_income_band_sk;
...
unsigned long QyAttributeHouseholdDemographicsHouseholdDemographics::get_lcnt(int key) {
...
unsigned long QyAttributeHouseholdDemographicsHouseholdDemographics::get_wlcnt(int key) {
...
unsigned long QyAttributeHouseholdDemographicsHouseholdDemographics::get_rcnt(int key) {
...
unsigned long QyAttributeHouseholdDemographicsHouseholdDemographics::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QyAttributeHouseholdDemographicsHouseholdDemographics::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QyAttributeHouseholdDemographicsHouseholdDemographics::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QyAttributeHouseholdDemographicsHouseholdDemographics::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QyAttributeHouseholdDemographicsHouseholdDemographics::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QyAttributeHouseholdDemographicsHouseholdDemographics::propagate_to_left(int key, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeHouseholdDemographicsHouseholdDemographics::propagate_to_right(int key, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeHouseholdDemographicsHouseholdDemographics::update_left_layer(int key, HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
    ...
    if (iter != left_layers.end()) {
        ...
        auto* layer = new std::vector<HouseholdDemographicsRow*>{row};
        left_layers.emplace(key, new std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*> {{new_count, layer}});
        left_layer_indices[*row] = 0;
        left_layer_max_unit_sizes.emplace(key, new_count);
    }
}

void QyAttributeHouseholdDemographicsHouseholdDemographics::update_right_layer(int key, HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
