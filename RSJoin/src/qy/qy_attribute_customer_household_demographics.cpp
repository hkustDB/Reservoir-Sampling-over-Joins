...
QyAttributeCustomerHouseholdDemographics::~QyAttributeCustomerHouseholdDemographics() {
...
void QyAttributeCustomerHouseholdDemographics::set_left_attribute(QyAttributeStoreSalesCustomer *attribute) {
    this->left_attribute = attribute;
}

void QyAttributeCustomerHouseholdDemographics::set_right_attribute(QyAttributeHouseholdDemographicsHouseholdDemographics *attribute) {
    this->right_attribute = attribute;
}

void QyAttributeCustomerHouseholdDemographics::set_left_relation_index(std::unordered_map<int, std::vector<CustomerRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QyAttributeCustomerHouseholdDemographics::set_right_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QyAttributeCustomerHouseholdDemographics::update_from_left(CustomerRow* row, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeCustomerHouseholdDemographics::update_from_right(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
unsigned long QyAttributeCustomerHouseholdDemographics::get_lcnt(int key) {
...
unsigned long QyAttributeCustomerHouseholdDemographics::get_wlcnt(int key) {
...
unsigned long QyAttributeCustomerHouseholdDemographics::get_rcnt(int key) {
...
unsigned long QyAttributeCustomerHouseholdDemographics::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<CustomerRow*>*>* QyAttributeCustomerHouseholdDemographics::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QyAttributeCustomerHouseholdDemographics::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QyAttributeCustomerHouseholdDemographics::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QyAttributeCustomerHouseholdDemographics::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QyAttributeCustomerHouseholdDemographics::propagate_to_left(int key, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeCustomerHouseholdDemographics::propagate_to_right(int key, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeCustomerHouseholdDemographics::update_left_layer(int key, CustomerRow *row, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeCustomerHouseholdDemographics::update_right_layer(int key, HouseholdDemographicsRow *row, unsigned long old_count, unsigned long new_count) {
