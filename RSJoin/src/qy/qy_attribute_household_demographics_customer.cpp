...
QyAttributeHouseholdDemographicsCustomer::~QyAttributeHouseholdDemographicsCustomer() {
...
void QyAttributeHouseholdDemographicsCustomer::set_left_attribute(QyAttributeHouseholdDemographicsHouseholdDemographics *attribute) {
    this->left_attribute = attribute;
}

void QyAttributeHouseholdDemographicsCustomer::set_left_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QyAttributeHouseholdDemographicsCustomer::set_right_relation_index(std::unordered_map<int, std::vector<CustomerRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QyAttributeHouseholdDemographicsCustomer::update_from_left(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeHouseholdDemographicsCustomer::update_from_right(CustomerRow* row, unsigned long old_count, unsigned long new_count) {
...
unsigned long QyAttributeHouseholdDemographicsCustomer::get_lcnt(int key) {
...
unsigned long QyAttributeHouseholdDemographicsCustomer::get_wlcnt(int key) {
...
unsigned long QyAttributeHouseholdDemographicsCustomer::get_rcnt(int key) {
...
unsigned long QyAttributeHouseholdDemographicsCustomer::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QyAttributeHouseholdDemographicsCustomer::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<CustomerRow*>*>* QyAttributeHouseholdDemographicsCustomer::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QyAttributeHouseholdDemographicsCustomer::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QyAttributeHouseholdDemographicsCustomer::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QyAttributeHouseholdDemographicsCustomer::propagate_to_left(int key, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeHouseholdDemographicsCustomer::update_left_layer(int key, HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
void QyAttributeHouseholdDemographicsCustomer::update_right_layer(int key, CustomerRow* row, unsigned long old_count, unsigned long new_count) {
