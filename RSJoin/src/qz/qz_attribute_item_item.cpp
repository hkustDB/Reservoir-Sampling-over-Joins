...
QzAttributeItemItem::~QzAttributeItemItem() {
...
void QzAttributeItemItem::set_right_attribute(QzAttributeItemStoreSales *attribute) {
    this->right_attribute = attribute;
}

void QzAttributeItemItem::set_left_relation_index(std::unordered_map<int, std::vector<ItemRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QzAttributeItemItem::set_right_relation_index(std::unordered_map<int, std::vector<ItemRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QzAttributeItemItem::update_from_left(ItemRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
...
void QzAttributeItemItem::update_from_right(ItemRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
    int key = row->i_category_id;
...
unsigned long QzAttributeItemItem::get_lcnt(int key) {
...
unsigned long QzAttributeItemItem::get_wlcnt(int key) {
...
unsigned long QzAttributeItemItem::get_rcnt(int key) {
...
unsigned long QzAttributeItemItem::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<ItemRow*>*>* QzAttributeItemItem::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<ItemRow*>*>* QzAttributeItemItem::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QzAttributeItemItem::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QzAttributeItemItem::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QzAttributeItemItem::propagate_to_right(int key, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeItemItem::update_left_layer(int key, ItemRow* row, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeItemItem::update_right_layer(int key, ItemRow* row, unsigned long old_count, unsigned long new_count) {
    ...
    if (iter != right_layers.end()) {
        ...
        auto* layer = new std::vector<ItemRow*>{row};
        right_layers.emplace(key, new std::unordered_map<unsigned long, std::vector<ItemRow*>*> {{new_count, layer}});
        right_layer_indices[*row] = 0;
        right_layer_max_unit_sizes.emplace(key, new_count);
    }
}

unsigned long QzAttributeItemItem::get_propagation_cnt() {
