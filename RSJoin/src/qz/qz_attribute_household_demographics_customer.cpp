...
void QzAttributeHouseholdDemographicsCustomer::set_left_attribute(QzAttributeHouseholdDemographicsHouseholdDemographics *attribute) {
    this->left_attribute = attribute;
}

void QzAttributeHouseholdDemographicsCustomer::set_left_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QzAttributeHouseholdDemographicsCustomer::set_right_relation_index(std::unordered_map<int, std::vector<CustomerRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QzAttributeHouseholdDemographicsCustomer::update_from_left(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
...
void QzAttributeHouseholdDemographicsCustomer::update_from_right(CustomerRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
...
unsigned long QzAttributeHouseholdDemographicsCustomer::get_lcnt(int key) {
...
unsigned long QzAttributeHouseholdDemographicsCustomer::get_wlcnt(int key) {
...
unsigned long QzAttributeHouseholdDemographicsCustomer::get_rcnt(int key) {
...
unsigned long QzAttributeHouseholdDemographicsCustomer::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QzAttributeHouseholdDemographicsCustomer::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<CustomerRow*>*>* QzAttributeHouseholdDemographicsCustomer::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QzAttributeHouseholdDemographicsCustomer::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QzAttributeHouseholdDemographicsCustomer::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QzAttributeHouseholdDemographicsCustomer::propagate_to_left(int key, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeHouseholdDemographicsCustomer::update_left_layer(int key, HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeHouseholdDemographicsCustomer::update_right_layer(int key, CustomerRow* row, unsigned long old_count, unsigned long new_count) {
...
unsigned long QzAttributeHouseholdDemographicsCustomer::get_propagation_cnt() {
