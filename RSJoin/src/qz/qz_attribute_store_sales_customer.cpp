...
void QzAttributeStoreSalesCustomer::set_left_attribute(QzAttributeItemStoreSales *attribute) {
    this->left_attribute = attribute;
}

void QzAttributeStoreSalesCustomer::set_right_attribute(QzAttributeCustomerHouseholdDemographics *attribute) {
    this->right_attribute = attribute;
}

void QzAttributeStoreSalesCustomer::set_left_relation_index(std::unordered_map<int, std::vector<StoreSalesRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QzAttributeStoreSalesCustomer::set_right_relation_index(std::unordered_map<int, std::vector<CustomerRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QzAttributeStoreSalesCustomer::update_from_left(StoreSalesRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
...
void QzAttributeStoreSalesCustomer::update_from_right(CustomerRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
...
unsigned long QzAttributeStoreSalesCustomer::get_lcnt(int key) {
...
unsigned long QzAttributeStoreSalesCustomer::get_wlcnt(int key) {
...
unsigned long QzAttributeStoreSalesCustomer::get_rcnt(int key) {
...
unsigned long QzAttributeStoreSalesCustomer::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<StoreSalesRow*>*>* QzAttributeStoreSalesCustomer::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<CustomerRow*>*>* QzAttributeStoreSalesCustomer::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QzAttributeStoreSalesCustomer::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QzAttributeStoreSalesCustomer::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QzAttributeStoreSalesCustomer::propagate_to_left(int key, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeStoreSalesCustomer::propagate_to_right(int key, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeStoreSalesCustomer::update_left_layer(int key, StoreSalesRow *row, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeStoreSalesCustomer::update_right_layer(int key, CustomerRow *row, unsigned long old_count, unsigned long new_count) {
...
unsigned long QzAttributeStoreSalesCustomer::get_propagation_cnt() {
