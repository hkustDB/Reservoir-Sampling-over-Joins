...
void QzAttributeHouseholdDemographicsHouseholdDemographics::set_left_attribute(QzAttributeCustomerHouseholdDemographics *attribute) {
    this->left_attribute = attribute;
}

void QzAttributeHouseholdDemographicsHouseholdDemographics::set_right_attribute(QzAttributeHouseholdDemographicsCustomer *attribute) {
    this->right_attribute = attribute;
}

void QzAttributeHouseholdDemographicsHouseholdDemographics::set_left_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->left_relation_index = relation_index;
}

void QzAttributeHouseholdDemographicsHouseholdDemographics::set_right_relation_index(std::unordered_map<int, std::vector<HouseholdDemographicsRow*>*>* relation_index) {
    this->right_relation_index = relation_index;
}

void QzAttributeHouseholdDemographicsHouseholdDemographics::update_from_left(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
...
void QzAttributeHouseholdDemographicsHouseholdDemographics::update_from_right(HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
    propagation_cnt += 1;
    int key = row->hd_income_band_sk;
...
unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_lcnt(int key) {
...
unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_wlcnt(int key) {
...
unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_rcnt(int key) {
...
unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_wrcnt(int key) {
...
std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QzAttributeHouseholdDemographicsHouseholdDemographics::get_left_layer(int key) {
    return left_layers.at(key);
}

std::unordered_map<unsigned long, std::vector<HouseholdDemographicsRow*>*>* QzAttributeHouseholdDemographicsHouseholdDemographics::get_right_layer(int key) {
    return right_layers.at(key);
}

unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_left_layer_max_unit_size(int key) {
    return left_layer_max_unit_sizes.at(key);
}

unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_right_layer_max_unit_size(int key) {
    return right_layer_max_unit_sizes.at(key);
}

void QzAttributeHouseholdDemographicsHouseholdDemographics::propagate_to_left(int key, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeHouseholdDemographicsHouseholdDemographics::propagate_to_right(int key, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeHouseholdDemographicsHouseholdDemographics::update_left_layer(int key, HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
void QzAttributeHouseholdDemographicsHouseholdDemographics::update_right_layer(int key, HouseholdDemographicsRow* row, unsigned long old_count, unsigned long new_count) {
...
unsigned long QzAttributeHouseholdDemographicsHouseholdDemographics::get_propagation_cnt() {
