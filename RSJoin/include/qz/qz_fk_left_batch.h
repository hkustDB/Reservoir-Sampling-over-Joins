#ifndef RESERVOIR_QZ_FK_LEFT_BATCH_H
#define RESERVOIR_QZ_FK_LEFT_BATCH_H
...
class QzFkLeftBatch {
public:
    QzFkLeftBatch(QzFkAttributeItemMiddle* qz_fk_attribute_item_middle, QzFkAttributeMiddleRight* qz_fk_attribute_middle_right);
