#ifndef RESERVOIR_QZ_ATTRIBUTE_HOUSEHOLD_DEMOGRAPHICS_CUSTOMER_H
#define RESERVOIR_QZ_ATTRIBUTE_HOUSEHOLD_DEMOGRAPHICS_CUSTOMER_H
...
public:
    ~QzAttributeHouseholdDemographicsCustomer();

    void set_left_attribute(QzAttributeHouseholdDemographicsHouseholdDemographics* attribute);
...
private:
    QzAttributeHouseholdDemographicsHouseholdDemographics* left_attribute;
...
#endif //RESERVOIR_QZ_ATTRIBUTE_HOUSEHOLD_DEMOGRAPHICS_CUSTOMER_H
