#ifndef RESERVOIR_DUMBBELL_RIGHT_BATCH_H
#define RESERVOIR_DUMBBELL_RIGHT_BATCH_H
...
public:
    DumbbellRightBatch(DumbbellAttributeLeftMiddle* dumbbell_attribute_left_middle, DumbbellAttributeMiddleRight* dumbbell_attribute_middle_right);

    void clear();
    void set_right_row(TriangleRow* row);
...
private:
    ...
    unsigned long left_layer_index = 0;
    unsigned long middle_layer_index = 0;

    std::vector<TriangleRow*>* left_layer = nullptr;
