#ifndef RESERVOIR_QY_ATTRIBUTE_STORE_SALES_CUSTOMER_H
#define RESERVOIR_QY_ATTRIBUTE_STORE_SALES_CUSTOMER_H
...
public:
    ~QyAttributeStoreSalesCustomer();

    void set_right_attribute(QyAttributeCustomerHouseholdDemographics* attribute);
...
private:
    QyAttributeCustomerHouseholdDemographics* right_attribute;
